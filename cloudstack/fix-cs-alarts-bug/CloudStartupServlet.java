...
public class CloudStartupServlet extends HttpServlet {
    ...
    @Override
    public void destroy() {
        s_logger.info("Stopping CloudStartupServlet....................\n");
        ComponentContext.uninitComponentsLifeCycle();
        try {
            Thread.sleep(10000);
    ...
    public void init(ServletConfig config) throws ServletException {
        ...
        s_logger.info("SpringBeanAutowiringSupport.processInjectionBasedOnServletContext...");
        ...
        _timer.scheduleAtFixedRate(new TimerTask() {
            @Override
            public void run() {
                s_logger.info("ComponentContext.getApplicationContext...");
                if (ComponentContext.getApplicationContext() != null) {
                    _timer.cancel();
                    s_logger.info("TransactionLegacy.open....");
